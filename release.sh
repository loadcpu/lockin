...
package_dmg() {
    ...
    swift generate_dmg_background.swift >/dev/null
    rm -f "$RW_DMG"
    rm -f "$output"
    ...
    mkdir -p "$abs_mount_point/Background"
    cp "$BKG_PNG" "$abs_mount_point/Background/background.png"
...
tell application "Finder"
    ...
    set bounds of container window of dmgAlias to {160, 160, 880, 520}
    set viewOptions to the icon view options of container window of dmgAlias
    set arrangement of viewOptions to not arranged
    set icon size of viewOptions to 112
    set bgFolder to folder "Background" of disk "dmg-mount"
    set bgFile to file "background.png" of bgFolder
    set background picture of viewOptions to bgFile
    set position of item "$APP.app" of container window of dmgAlias to {190, 170}
    set position of item "Applications" of container window of dmgAlias to {530, 170}
...
APPLESCRIPT
    ...
    SetFile -a V "$abs_mount_point/Background"
    SetFile -a V "$abs_mount_point/Background/background.png"
